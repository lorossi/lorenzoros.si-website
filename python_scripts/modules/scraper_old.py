...
class Scraper:
    ...
    def scrapeRepos(self) -> None:
        ...
        for repo in self._github.get_user().get_repos():
            ...
            if repo.private:
                logging.warning(f"skipping {repo.full_name}. Reason: private repo ")
                continue
    ...
    def formatRepos(self) -> None:
        ...
        html_list = f"<ul class='{' '.join(self._settings['css_list_classes'])}'>\n"
        ...
        for language in languages:
            ...
            # create html element
            html_list += f'{language}</div><div class="language">'
